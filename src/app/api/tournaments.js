...
router.patch('/singles/winner/:tourny_id', function(req, res) {
...
router.patch('/doubles/winner/:tourny_id', function(req, res) {
...
router.patch('/singles/ended/:tourny_id', function(req, res) {
...
router.patch('/doubles/ended/:tourny_id', function(req, res) {
...
router.patch('/singles/update_round/:tourny_id', function(req, res) {
...
router.patch('/doubles/update_round/:tourny_id', function(req, res) {
...
router.patch('/singles/update_playoffs/:tourny_id', function(req, res) {
...
router.patch('/doubles/update_playoffs/:tourny_id', function(req, res) {
